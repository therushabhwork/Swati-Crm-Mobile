...
export default function CustomerDetailsScreen() {
  ...
  if (isLoading) {
    return (
      <View style={styles.centerContainer}>
        <AppHeader title="Customer Details" showBack onBack={() => router.push('/(tabs)/customers')} />
  ...
  return (
    <View style={styles.container}>
      <AppHeader title={data.customerName || data.name || "Customer Details"} showBack onBack={() => router.push('/(tabs)/customers')} />
