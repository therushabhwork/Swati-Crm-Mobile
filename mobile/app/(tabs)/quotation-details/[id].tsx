...
export default function QuotationDetailsScreen() {
  ...
  if (isLoading) {
    return (
      <View style={styles.centerContainer}>
        <AppHeader title="Quotation Details" showBack onBack={() => router.push('/(tabs)/quotations')} />
  ...
  return (
    <View style={styles.container}>
      <AppHeader title={`Quotation #${data.quotationNo || data.quotationNumber || data.id || ''}`} showBack onBack={() => router.push('/(tabs)/quotations')} />
