...
export default function SupportDetailsScreen() {
  ...
  if (isLoading) {
    return (
      <View style={styles.centerContainer}>
        <AppHeader title="Support Request" showBack onBack={() => router.push('/(tabs)/support')} />
  ...
  return (
    <View style={styles.container}>
      <AppHeader title={`SR #${data.srNumber || data.ticketNo || data.id || ''}`} showBack onBack={() => router.push('/(tabs)/support')} />
