...
export default function TaskDetailsScreen() {
  ...
  if (isLoading) {
    return (
      <View style={styles.centerContainer}>
        <AppHeader title="Reminder Details" showBack onBack={() => router.push('/(admin)/reminders')} />
  ...
  return (
    <View style={styles.container}>
      <AppHeader title={data.title || data.taskName || "Reminder Details"} showBack onBack={() => router.push('/(admin)/reminders')} />
