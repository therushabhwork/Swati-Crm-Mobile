...
const actionConfig = [
  ...
  },
  {
    ...
    route: '',
    placeholderTitle: 'View Quotations',
    heading: 'View Quotations',
    description: 'Navigate to Quotation Manager with selected account pre-filtered to view its quotations.',
    behavior: 'viewQuotations',
  },
