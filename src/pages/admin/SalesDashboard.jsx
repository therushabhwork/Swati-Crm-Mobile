...
const SalesDashboard = () => {
  ...
  return (
    <div className="sales-dashboard">
              ...
              >
                ...
                <Tooltip 
                  ...
                  contentStyle={{ 
                    ...
                    boxShadow: '0 6px 14px rgba(198, 0, 22, 0.12)',
                    backgroundColor: '#ffffff',
                    color: '#111827',
                    padding: '5px 8px',
                    fontSize: '0.72rem'
                  }}
                  itemStyle={{ color: '#c60016', fontWeight: 800, fontSize: '0.72rem' }}
                />
                <Bar 
                  dataKey="count" 
      ...
      >
        <Card className="sales-card full-width sales-high-value-card" padding={false}>
          <div className="card-header">
