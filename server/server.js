...
const supportRequestDocumentRoutes = require('./routes/supportRequestDocumentRoutes')
...
app.use('/api/support-request-documents', requireBackendReady, supportRequestDocumentRoutes)
